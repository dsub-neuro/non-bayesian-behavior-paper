function decision = bayes_decision_simulation_lapses(x, jumpDist, noJumpDist, noise, priorMinusLogOdds, lowerBound, lapse)
...
%% get decision    
    decision = lowerBound + (1 - lowerBound - lapse).*(1 - ncx2cdf(criterion/noise^2, 1, x.^2/noise^2));
end