expFolder = 'C:\Users\Divya\Documents\Divya data\Non Bayesian behavior paper data\Human\Noise'; %switch to Noise Experiment folder
cd(expFolder)
%Participant names and dates to refer to data folders
names = {'P00', 'P0', 'P1', 'P2', 'P3', 'P4', 'P6', 'P7', 'P8'};
