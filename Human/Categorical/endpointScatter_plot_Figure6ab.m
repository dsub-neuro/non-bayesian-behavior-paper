%% Generates endpoint scatter plots for the categorical experiment in Figure 6a-b

load('C:\Users\Divya\Documents\Divya data\Non Bayesian behavior paper data\Human\Categorical\endPointScatter_noiseLevels.mat')
