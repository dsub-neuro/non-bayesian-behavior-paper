% generates the plots for the human categorical experiment in Figures 3 and 4 or extended figure . 
...
% load('C:\Users\Divya\Documents\Divya data\Non Bayesian behavior paper data\Human\Categorical\summary_inSac_4P_2.mat')
% load('C:\Users\Divya\Documents\Divya data\Non Bayesian behavior paper data\Human\Categorical\inSac_pooledCurves_4P_2.mat')
% %opposite to saccade direction
% load('C:\Users\Divya\Documents\Divya data\Non Bayesian behavior paper data\Human\Categorical\summary_oppSac_4P_2.mat')
% load('C:\Users\Divya\Documents\Divya data\Non Bayesian behavior paper data\Human\Categorical\oppSac_pooledCurves_4P_2.mat')
